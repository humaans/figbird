...
export function useQuery(serviceName, options = {}, queryHookOptions = {}) {
  ...
  const q = useMemo(
    () => queryManager.createQuery({ service: serviceName, method, id, params }),
 ...
 */
export function useQuery2(serviceName, options = {}, queryHookOptions = {}) {
  ...
  useEffect(() => {
    ...
    return qm.addQuery({ service: serviceName, method, id, params })
